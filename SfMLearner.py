...
class SfMLearner(object):
    ...
    def build_train_graph(self):
        ...
        with tf.name_scope("data_loading"):
            tgt_image, src_image_stack, Itr, BF, intrinsics = loader.load_train_batch()
        ...
        with tf.name_scope("compute_loss"):
            ...
            total_loss = pixel_loss + smooth_loss + consistency_loss + appearance_loss + exp_loss #+ flow_consistency_loss
