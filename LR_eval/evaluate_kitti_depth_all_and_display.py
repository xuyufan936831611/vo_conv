...
parser.add_argument('--predicted_disp_path', type=str, help='path to estimated disparities',
                    default='/home/omnisky/xuyufan/VO_conv/disparity_r')
parser.add_argument('--gt_path', type=str, help='path to ground truth disparities',default='/media/omnisky/'
'902177fe-4ad6-4003-be5e-0f539ffb197c/xuyufan/备份/视觉里程计/dataset/KITTI/raw_data/kitti_raw_eigen/')
...
parser.add_argument('--output_dir', type=str,default='/home/omnisky/xuyufan/VO_conv/disparity_r')
parser.add_argument('--output_dir_gt', type=str,default='/')
...
if __name__ == '__main__':
    ...
    for disp in disp_files:
        if disp=="/home/omnisky/xuyufan/VO_conv/disparity_r/disparities_r.npy":
            ...
            if args.split == 'kitti':
                ...
                for t_id in range(num_samples):
                    ...
                    vertical_stack = np.concatenate((input_float, cv2.resize(colored_map,(1242,375))), axis=0)
                    ...
                    depth_gt = np.concatenate((white, cv2.resize(depth_display_gt,(1242,int(0.60 *375)))), axis=0)
