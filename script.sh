...
python train.py --dataset_dir_l=/media/omnisky/902177fe-4ad6-4003-be5e-0f539ffb197c/xuyufan/SVO_RNN_N_sequences/vo_dump_3/02 --dataset_dir_r=/media/omnisky/902177fe-4ad6-4003-be5e-0f539ffb197c/xuyufan/SVO_RNN_N_sequences/vo_dump_3/03 --checkpoint_dir=checkpoints_decouple1by4/ --img_width=416 --img_height=128 --batch_size=4
...
5、
python test_kitti_depth.py --dataset_dir /media/omnisky/902177fe-4ad6-4003-be5e-0f539ffb197c/xuyufan/备份/视觉里程计/dataset/KITTI/raw_data/kitti_raw_eigen/ --output_dir depth_mask/ --ckpt_file checkpoints/model-191178


python kitti_eval/eval_depth.py --kitti_dir=/media/omnisky/902177fe-4ad6-4003-be5e-0f539ffb197c/xuyufan/备份/视觉里程计/dataset/KITTI/raw_data/kitti_raw_eigen/ --pred_file=depth_3/model-147180.npy
...
/usr/bin/python test_kitti_pose_all.py --dataset_dir /home/omnisky/xuyufan/视觉里程计/dataset/KITTI/ --output_dir pose_data/  --ckpt_dir checkpoints
/usr/bin/python kitti_eval/eval_pose_all.py --gtruth_dir=/home/omnisky/xuyufan/视觉里程计/old_version/their_code_python2/UNDEEPVO/kitti_eval/pose_data/ground_truth/ --pred_dir=pose_data/
...
/usr/bin/python LR_eval/evaluate_kitti_depth_all.py --gt_path=/home/omnisky/xuyufan/视觉里程计/dataset/KITTI/raw_data/kitti_raw_eigen/ --predicted_disp_path=depth_mask --split=eigen --garg_crop
