...
def main():
    # tra_dir='zhou_09.txt'
    # true_dir='/home/omnisky/xuyufan/备份/gt/dataset/poses/09.txt'
    # mine_abs_dir='zhou_abs_09.txt'
    # file = open(tra_dir)
    ...
    ############################################################################################################
    tra_dir = 'ours_09.txt'
    true_dir = '/media/omnisky/902177fe-4ad6-4003-be5e-0f539ffb197c/xuyufan/备份/备份/gt/dataset/poses/09.txt'#model-239559
    mine_abs_dir = 'ours_abs_09.txt'
    file = open(tra_dir)
    file_true = open(true_dir)
    file_abs = open(mine_abs_dir, 'w')
    contents = file.readlines()
